jQuery(document).ready(function($) {
  // variables
  let hijacking = $('body').data('hijacking');
  ...
  // DOM elements
  let sectionsAvailable = $('.cd-section');
        var verticalNav = $('.cd-vertical-nav');
        var prevArrow = verticalNav.find('a.cd-prev');
        var nextArrow = verticalNav.find('a.cd-next');
  ...
  function animateSection() {
    ...
    sectionsAvailable.each(function() {
      let actualBlock = $(this);
                var offset = scrollTop - actualBlock.offset().top;
  ...
  function initHijacking() {
    ...
    let visibleSection = sectionsAvailable.filter('.visible');
            var topSection = visibleSection.prevAll('.cd-section');
            var bottomSection = visibleSection.nextAll('.cd-section');
            var animationParams = selectAnimation(animationType, false);
            var animationVisible = animationParams[0];
            var animationTop = animationParams[1];
            var animationBottom = animationParams[2];
  ...
  function prevSection(event) {
    ...
    let visibleSection = sectionsAvailable.filter('.visible');
            var middleScroll = !!((hijacking == 'off' && $(window).scrollTop() != visibleSection.offset().top));
  ...
  function selectAnimation(animationName, middleScroll, direction) {
    ...
    let animationVisible = 'translateNone';
            var animationTop = 'translateUp';
            var animationBottom = 'translateDown';
            var easing = 'ease';
